      ...
      <div className=" 2xl:container 2xl:mx-auto md:py-12  md:px-6 py-9 px-4">
        ...
        <div className=" flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
          <div className=" md:w-5/12 lg:w-4/12 w-full ">
            <img
              src="https://m.media-amazon.com/images/I/71YkyScjmWS._AC_SY500_.jpg"
              alt="h71YkyScjmWS._AC_SY500_.jpg"
              className=" md:block hidden h-[60vh]"
            />
            <img
              src="https://m.media-amazon.com/images/I/71c-JkNMe1L._AC_SX385_.jpg"
              alt="Img of Glass bottle"
              className="h-[50vh] md:hidden block "
            />
          </div>
