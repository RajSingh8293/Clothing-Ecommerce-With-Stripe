...
const ReducxProducts = () => {
  const dispatch = useDispatch()
  const { loading, products, error, updateState, response } = useSelector(
  ...
  const updateForm = () => {
    dispatch(updateProduct({ id: id, name: name, position: position }))
