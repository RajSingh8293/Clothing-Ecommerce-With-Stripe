...
const AdminProductDetails = () => {
  ...
  const { singledata: product } = useSelector((state) => state.products)
          ...
          <div className="lg:w-[60%] w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex w-[100%]">
              <NavLink
                ...
                className="flex justify-center items-center w-[100%] text-white bg-red-800 border-0 py-2 px-6 focus:outline-none hover:bg-black"
              >
                Update
              </NavLink>
            </div>
